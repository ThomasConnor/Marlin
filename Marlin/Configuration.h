...
#define CUSTOM_MACHINE_NAME "SKRmE3v1.2_DD"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // Creality Ender-3 - M303 E0 S200 C8 U1
    #define DEFAULT_Kp 21.82
    #define DEFAULT_Ki 1.96
    #define DEFAULT_Kd 60.77
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 140 } // esteps at 140 for 5mm hob goblin
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -10, -3.50 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNER_INSET 40
  #define LEVEL_CORNERS_INSET_LFRB { LEVEL_CORNER_INSET, LEVEL_CORNER_INSET, LEVEL_CORNER_INSET, LEVEL_CORNER_INSET} // (mm) Left, Front, Right, Back insets
